package model.game.team.ai.neuralnet;

import model.game.team.ai.neuralnet.math.Matrix;
import model.game.team.ai.neuralnet.math.Vector;
import model.game.team.ai.neuralnet.optimizer.GradientDescent;
import model.game.team.ai.neuralnet.optimizer.Optimizer;
...
public final class NeuralNetwork implements Serializable {
     ...
     * The Cost function.
     */
    private final transient CostFunction costFunction;
    /**
     * The Layers.
     */
     ...
     */
    private final transient int networkInputSize;
    /**
     * The Optimizer.
     */
